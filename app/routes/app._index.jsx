...
export const loader = async ({ request }) => {
  ...
  return {
    needsDraftOrderScope: !hasDraftOrderScope,
  };
};
  ...
  return (
    <s-page heading="Banner Design Preview">
      ...
      {needsDraftOrderScope && (
        <s-section heading="Draft orders (custom banner sizes)">
          <s-paragraph>
            Grant permission to create draft orders so customers can check out when their banner dimensions do not match a preset variant.
          </s-paragraph>
